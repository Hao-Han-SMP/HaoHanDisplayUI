...
public final class UiText {
    ...
    /**
     * Estimates width using Minecraft's default font advances. Consumers using
     * custom resource-pack fonts can override it with contentWidth(...).
     */
    ...
    public static final class Builder {
        ...
        /** Applies a piecewise-linear gradient across Unicode code points. */
        ...
        /**
         * @param factor gradient intensity from 0 (first color only) to 1
         *               (the complete multi-stop gradient)
         */
        public Builder gradient(String text, List<? extends TextColor> stops,
